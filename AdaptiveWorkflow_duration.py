import os
from GlobalConfig import onat_list
...
from Function_common import point_path_data
from Function_common import nan_digitize
from GlobalConfig import log_points, path_out
from Graphics import draw_hist_dq, draw_hist_data_collapse, plt_duration_hist
from Graphics import draw_hist_dq_dataarray
from Graphics_Wdp import wdp_era5_lfp, combined_plot, plot_map, plot_distribution
...
#     # 获取参数
#     era5_frequency, era5_frequency_np, fig_path, figure_title_font, func_percentile, lat_range, raw_dr, sp_frequency, sp_percentile, var = parm_set(data_set, dec, module, percentile_name, rd, var)
...
if __name__ == '__main__':
    ...
    main_process(f'{start_key}', renew='011', data_set='era5')
