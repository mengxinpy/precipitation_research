...
for a in range(0, 4):
    ...
    with h5py.File(file_name_list[a] + '.mat', 'r') as f:
        print(f.keys())
        raw_variables = f[variable_name_list[a]][()][:, :, :, :365]
        f.close()
    ...
    for i in range(out_num):
        for v in ['vapor', 'rain']:
            ...
            np.save('decode_' + v + str(a) + '_8th', decode_out_variables)
            ...
            save_path = 'pcaPicture8th\\' + area_name_list[a] + '\\' + area_name_list[a] + '_' + str(i) + 'th_' + v + '.png'
