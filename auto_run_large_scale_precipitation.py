import xarray as xr
from function_percentile import lsprf_percentile
...
bins, indices, data_percentile, data_frequency = lsprf_percentile(dr=point_path_data('total_precipitation', lat=lat_range), lsp=point_path_data(var, lat=lat_range)  # 路径参数
