...
bins, indices, data_percentile, data_frequency = lspf_percentile(dr=point_path_data('total_precipitation', lat=lat_range), lspf=point_path_data(var, lat=lat_range)  # 路径参数
