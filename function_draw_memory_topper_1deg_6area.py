...
def dm_area_top(bins, log_points, area_top_per_all, selected_columns, dm_in, sp_dm_frequency, sp_dm_lagtime, figure_title, figure_title_font, colorbar_title, dec=None):
    plt.close()
    assert len(bins) == 6
