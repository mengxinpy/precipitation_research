...
from Function_common import just_spectrum, depart_ml_lat
from GlobalConfig_graphic import adjust_all_font_sizes
from GlobalConfig_graphic import setup_colorbar, auto_close_plot, format_tick, setup_colors, set_fonts_for_fig
