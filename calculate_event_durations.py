...
def calculate_every_event_durations(precipitation_array, percentile_th, mask_array):
    ...
    durations = method_name_all(end_events, mask_array, precipitation_array, start_events)
    durations_qt = method_name_all(end_events_qt, mask_array, precipitation_array, start_events_qt)
...
def method_name_all(end_events, mask_array, precipitation_array, start_events):
