...
from Graphics import multi_scatter_plot, plt_duration_origin, plt_duration_gamma, scatter_plots_combined_no_rect, scatter_plots_combined_final, plt_duration_exp
