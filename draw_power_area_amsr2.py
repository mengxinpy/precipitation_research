...
avg_rain = np.load(f".\\temp_data\\amsr2_power_{deg}_{vapor_bins_count}_{flat}_avg_rain.npy")
count = np.load(f".\\temp_data\\amsr2_power_{deg}_{vapor_bins_count}_{flat}_count.npy")
binder = np.load(f".\\temp_data\\amsr2_power_{deg}_{vapor_bins_count}_{flat}_binder.npy")
var = np.load(f".\\temp_data\\amsr2_power_{deg}_{vapor_bins_count}_{flat}_var.npy")
