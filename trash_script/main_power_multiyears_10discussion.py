...
for y in range(2000, 2010):
    for m in range(1, 13):  # 遍历月
        ...
        for i in range(1, len(wetday_bins) + 1):
            ...
            select_region_1mm = rainfall_region > 0
...
np.save('power_10years00_noweight_0.npy', results_final)
np.save('count_10years00_noweight_0.npy', count)
np.save('Binder_4th_order_Cumulant_0.npy', Binder_4th_order_Cumulant)
