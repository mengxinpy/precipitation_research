...
#     inverse_X = X[len(X)::-1]
#     len_year = 365
#     a = np.sum(inverse_X[len_year - 10:len_year + 10])
#     print(a)
...
def get_all_duration_frequency(dr, percentile=30,out_dir=None):
    ...
    file_name = f'./internal_data/{out_dir}/top{percentile:.0f}%_frequency.nc'
